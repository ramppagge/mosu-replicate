...
export default function Location() {
  return (
    <section id="visit" className="py-16 md:py-24 lg:py-40 bg-brand-dark overflow-hidden">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.05] tracking-tight mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {locations.map((loc, i) => (
            <motion.a
              ...
              whileHover={{ y: -4 }}
              className="group relative p-5 sm:p-8 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-colors duration-300"
            >
              {/* Green dot */}
        ...
        <motion.div
          ...
          className="text-center p-5 sm:p-8 rounded-2xl border border-brand-accent/20 bg-brand-accent/5"
        >
          <div className="flex items-center justify-center gap-3 mb-2">
            <span className="w-3 h-3 rounded-full bg-brand-accent animate-pulse" />
            <span className="font-display text-lg sm:text-xl md:text-2xl font-bold text-white">
              {openingHours}
            </span>
          </div>
